package com.artillexstudios.axapi.nms.v1_19_R2.items;
...
import com.artillexstudios.axapi.nms.v1_19_R2.ItemStackSerializer;
...
public class WrappedItemStack implements com.artillexstudios.axapi.items.WrappedItemStack {
    ...
    public <T> void set(DataComponent<T> component, T value) {
        if (component == DataComponent.CUSTOM_DATA) {
            ...
            this.tag = ((com.artillexstudios.axapi.nms.v1_19_R2.items.nbt.CompoundTag) value).getParent();
