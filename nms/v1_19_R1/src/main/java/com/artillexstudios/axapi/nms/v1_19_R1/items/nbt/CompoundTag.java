package com.artillexstudios.axapi.nms.v1_19_R1.items.nbt;
...
public class CompoundTag implements com.artillexstudios.axapi.items.nbt.CompoundTag {
    ...
    public void put(String key, Tag tag) {
        this.parent.put(key, tag.getParent() instanceof net.minecraft.nbt.CompoundTag compoundTag ? compoundTag : (ListTag) tag.getParent());
    }
    ...
    public com.artillexstudios.axapi.items.nbt.ListTag getList(String key) {
        return new com.artillexstudios.axapi.nms.v1_19_R1.items.nbt.ListTag(parent.getList(key, 10));
    }
