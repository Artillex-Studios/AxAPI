package com.artillexstudios.axapi.nms.v1_21_R5.items;
...
public record HashedStack(
    ...
    public static HashedStack create(com.artillexstudios.axapi.nms.v1_21_R5.items.WrappedItemStack stack, HashGenerator generator) {
    ...
    public boolean matches(WrappedItemStack stack, HashGenerator generator) {
        return this.stack.matches(((com.artillexstudios.axapi.nms.v1_21_R5.items.WrappedItemStack) stack).itemStack, generator::apply);
    }
