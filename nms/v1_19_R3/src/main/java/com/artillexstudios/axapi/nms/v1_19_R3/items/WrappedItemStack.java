package com.artillexstudios.axapi.nms.v1_19_R3.items;
...
import com.artillexstudios.axapi.nms.v1_19_R3.ItemStackSerializer;
...
public class WrappedItemStack implements com.artillexstudios.axapi.items.WrappedItemStack {
    ...
    public com.artillexstudios.axapi.items.nbt.CompoundTag getCompoundTag() {
        ...
        return new com.artillexstudios.axapi.nms.v1_19_R3.items.nbt.CompoundTag(tag);
    }
    ...
    public <T> void set(DataComponent<T> component, T value) {
        if (component == DataComponent.CUSTOM_DATA) {
            ...
            this.tag = ((com.artillexstudios.axapi.nms.v1_19_R3.items.nbt.CompoundTag) value).getParent();
