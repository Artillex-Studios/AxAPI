package com.artillexstudios.axapi.nms.v26_1.packet;

import com.artillexstudios.axapi.items.HashedStack;
import com.artillexstudios.axapi.nms.v26_1.items.WrappedItemStack;
...
public record FriendlyByteBufWrapper(RegistryFriendlyByteBuf buf) implements FriendlyByteBuf {
    ...
    public HashedStack readHashedStack() {
        return new com.artillexstudios.axapi.nms.v26_1.items.HashedStack(net.minecraft.network.HashedStack.STREAM_CODEC.decode(this.buf));
    }

    @Override
    public void writeHashedStack(HashedStack stack) {
        net.minecraft.network.HashedStack.STREAM_CODEC.encode(this.buf, ((com.artillexstudios.axapi.nms.v26_1.items.HashedStack) stack).stack());
    }
