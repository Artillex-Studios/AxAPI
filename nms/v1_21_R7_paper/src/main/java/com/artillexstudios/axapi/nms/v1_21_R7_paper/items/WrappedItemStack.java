...
import com.artillexstudios.axapi.nms.v1_21_R7_paper.ItemStackSerializer;
...
public class WrappedItemStack implements com.artillexstudios.axapi.items.WrappedItemStack {
    ...
    public HashedStack toHashedStack(HashGenerator generator) {
        return com.artillexstudios.axapi.nms.v1_21_R7_paper.items.HashedStack.create(this, generator);
    }
