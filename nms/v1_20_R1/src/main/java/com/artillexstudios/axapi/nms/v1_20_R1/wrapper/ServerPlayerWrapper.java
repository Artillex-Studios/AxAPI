...
import com.artillexstudios.axapi.nms.v1_20_R1.packet.ChannelDuplexHandlerPacketListener;
...
public final class ServerPlayerWrapper implements com.artillexstudios.axapi.nms.wrapper.ServerPlayerWrapper {
    ...
    public void inject() {
        ...
        channel.eventLoop().submit(() -> {
            channel.pipeline().addBefore(ServerPlayerWrapper.PACKET_HANDLER, ServerPlayerWrapper.AXAPI_HANDLER, new ChannelDuplexHandlerPacketListener(this.wrapped()));
        });
    }
