package com.artillexstudios.axapi.nms.v1_20_R1.items.datacomponents;
...
import com.artillexstudios.axapi.nms.v1_20_R1.items.datacomponents.impl.CustomDataDataComponent;
import com.artillexstudios.axapi.nms.v1_20_R1.items.datacomponents.impl.CustomModelDataDataComponent;
import com.artillexstudios.axapi.nms.v1_20_R1.items.datacomponents.impl.DataComponentHandler;
import com.artillexstudios.axapi.nms.v1_20_R1.items.datacomponents.impl.DirectDataComponent;
import com.artillexstudios.axapi.nms.v1_20_R1.items.datacomponents.impl.DyedColorDataComponent;
import com.artillexstudios.axapi.nms.v1_20_R1.items.datacomponents.impl.EnchantmentGlintOverrideDataComponent;
import com.artillexstudios.axapi.nms.v1_20_R1.items.datacomponents.impl.EnchantmentsDataComponent;
import com.artillexstudios.axapi.nms.v1_20_R1.items.datacomponents.impl.LoreDataComponent;
import com.artillexstudios.axapi.nms.v1_20_R1.items.datacomponents.impl.MaterialDataComponent;
import com.artillexstudios.axapi.nms.v1_20_R1.items.datacomponents.impl.NameDataComponent;
import com.artillexstudios.axapi.nms.v1_20_R1.items.datacomponents.impl.PotionContentsDataComponent;
import com.artillexstudios.axapi.nms.v1_20_R1.items.datacomponents.impl.ProfileDataComponent;
import com.artillexstudios.axapi.nms.v1_20_R1.items.datacomponents.impl.UnbreakableDataComponent;
...
//        register("base_color", DataComponents.BASE_COLOR, new DyedColorDataComponent());
    ...
    public static <T, Z> void register(String id, DataComponentHandler<T> mapper) {
        register(id, com.artillexstudios.axapi.nms.v1_20_R1.items.datacomponents.impl.DataComponent.create(id, mapper));
    }
