...
import com.artillexstudios.axapi.nms.v1_20_R1.entity.PacketAreaEffectCloud;
import com.artillexstudios.axapi.nms.v1_20_R1.entity.PacketArmorStand;
import com.artillexstudios.axapi.nms.v1_20_R1.entity.PacketItem;
...
public class PacketEntityFactory implements com.artillexstudios.axapi.packetentity.PacketEntityFactory {
    ...
    public PacketEntity spawnEntity(Location location, EntityType entityType, Consumer<PacketEntity> consumer) {
        ...
        if (entityType == EntityType.ARMOR_STAND) {
            ...
            entity = new com.artillexstudios.axapi.nms.v1_20_R1.entity.PacketEntity(entityType, location, consumer);
        }
