package com.artillexstudios.axapi.nms.v1_21_R2.items.datacomponents.impl;
...
public final class CustomDataDataComponent implements DataComponentHandler<CompoundTag, CustomData> {
    ...
    public CustomData toNMS(CompoundTag from) {
        return CustomData.of(((com.artillexstudios.axapi.nms.v1_21_R2.items.nbt.CompoundTag) from).getParent());
    }
