package com.artillexstudios.axapi.nms.v26_3.wrapper;

import com.artillexstudios.axapi.items.HashGenerator;
import com.artillexstudios.axapi.nms.v26_3.packet.ChannelDuplexHandlerPacketListener;
...
public final class ServerPlayerWrapper implements com.artillexstudios.axapi.nms.wrapper.ServerPlayerWrapper {
    ...
    private static final FieldAccessor containerSynchronizerAccessor = FieldAccessor.builder()
            ...
            .withField("containerSynchronizer")
            .build();
