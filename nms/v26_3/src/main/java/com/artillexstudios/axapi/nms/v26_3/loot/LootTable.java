package com.artillexstudios.axapi.nms.v26_3.loot;
...
import com.artillexstudios.axapi.nms.v26_3.items.WrappedItemStack;
...
public class LootTable implements com.artillexstudios.axapi.loot.LootTable {
    private static final IdentityHashMap<LootContextParam<?>, ContextKey<Object>> params = new IdentityHashMap<>() {{
        ...
        this.put(LootContextParams.INTERACTING_ENTITY, (ContextKey<Object>) (Object) net.minecraft.world.level.storage.loot.parameters.LootContextParams.INTERACTING_ENTITY);
        this.put(LootContextParams.TARGET_ENTITY, (ContextKey<Object>) (Object) net.minecraft.world.level.storage.loot.parameters.LootContextParams.TARGET_ENTITY);
    ...
    private static final EnumMap<LootContextParamSets, ContextKeySet> sets = new EnumMap<>(LootContextParamSets.class) {{
        ...
        this.put(LootContextParamSets.ENTITY_INTERACT, net.minecraft.world.level.storage.loot.parameters.LootContextParamSets.ENTITY_INTERACT);
        this.put(LootContextParamSets.BLOCK_INTERACT, net.minecraft.world.level.storage.loot.parameters.LootContextParamSets.BLOCK_INTERACT);
    ...
    public LootTable(Key key) {
        this.lootTable = MinecraftServer.getServer().reloadableRegistries().getLootTable(ResourceKey.create(Registries.LOOT_TABLE, Identifier.fromNamespaceAndPath(key.namespace(), key.value())));
    }
    ...
    public List<ItemStack> randomItems(LootParams params) {
        ...
        for (net.minecraft.world.item.ItemStack item : items) {
            returning.add(WrappedItemStack.asCraftMirror(item));
        }
