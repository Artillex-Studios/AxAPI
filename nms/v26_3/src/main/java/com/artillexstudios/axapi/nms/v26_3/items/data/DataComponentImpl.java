package com.artillexstudios.axapi.nms.v26_3.items.data;
    ...
    public DataComponent<CompoundTag> customData() {
        return new DataComponent<>() {
            ...
            public CompoundTag get(Object item) {
                ...
                return new com.artillexstudios.axapi.nms.v26_3.items.nbt.CompoundTag(itemStack.getOrDefault(DataComponents.CUSTOM_DATA, CustomData.of(new net.minecraft.nbt.CompoundTag())).copyTag());
            }
        };
    }
