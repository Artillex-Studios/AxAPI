package com.artillexstudios.axapi.nms.v26_3.items;
...
public class WrappedItemStack implements com.artillexstudios.axapi.items.WrappedItemStack {
    ...
    public ItemStack toBukkit() {
        return WrappedItemStack.asCraftMirror(this.itemStack.copy());
    }

    @Override
    public HashedStack toHashedStack(HashGenerator generator) {
        return com.artillexstudios.axapi.nms.v26_3.items.HashedStack.create(this, generator);
    }
    ...
    public static CraftItemStack asCraftMirror(net.minecraft.world.item.ItemStack itemStack) {
        if (PaperUtils.isPaper()) {
            return (CraftItemStack) CraftItemStack.asBukkitMirror(itemStack);
        }

        return MethodUtils.INSTANCE.invokeStaticMethod(MethodUtils.INSTANCE.getMethod(CraftItemStack.class, "asCraftMirror", net.minecraft.world.item.ItemStack.class), itemStack);
    }
}
