package com.artillexstudios.axapi.nms.v26_3.items.datacomponents;
...
import com.artillexstudios.axapi.nms.v26_3.items.datacomponents.impl.AdventureComponentDataComponent;
import com.artillexstudios.axapi.nms.v26_3.items.datacomponents.impl.CustomDataDataComponent;
import com.artillexstudios.axapi.nms.v26_3.items.datacomponents.impl.CustomModelDataDataComponent;
import com.artillexstudios.axapi.nms.v26_3.items.datacomponents.impl.DataComponentHandler;
import com.artillexstudios.axapi.nms.v26_3.items.datacomponents.impl.DyedColorDataComponent;
import com.artillexstudios.axapi.nms.v26_3.items.datacomponents.impl.EnchantmentsDataComponent;
import com.artillexstudios.axapi.nms.v26_3.items.datacomponents.impl.IdentifierDataComponent;
import com.artillexstudios.axapi.nms.v26_3.items.datacomponents.impl.IdentityDataComponent;
import com.artillexstudios.axapi.nms.v26_3.items.datacomponents.impl.LoreDataComponent;
import com.artillexstudios.axapi.nms.v26_3.items.datacomponents.impl.MaterialDataComponent;
import com.artillexstudios.axapi.nms.v26_3.items.datacomponents.impl.PotionContentsDataComponent;
import com.artillexstudios.axapi.nms.v26_3.items.datacomponents.impl.ProfileDataComponent;
import com.artillexstudios.axapi.nms.v26_3.items.datacomponents.impl.RarityDataComponent;
import com.artillexstudios.axapi.nms.v26_3.items.datacomponents.impl.TooltipDisplayDataComponent;
import com.artillexstudios.axapi.nms.v26_3.items.datacomponents.impl.UnitDataComponent;
...
//        register("base_color", DataComponents.BASE_COLOR, new DyedColorDataComponent());
    ...
    public static <T, Z> void register(String id, DataComponentType<@NotNull Z> type, DataComponentHandler<T, Z> mapper) {
        register(id, com.artillexstudios.axapi.nms.v26_3.items.datacomponents.impl.DataComponent.create(id, type, mapper));
    }
