package com.artillexstudios.axapi.nms.v26_3.packet;
...
public record FriendlyByteBufWrapper(RegistryFriendlyByteBuf buf) implements FriendlyByteBuf {
    ...
    public HashedStack readHashedStack() {
        return new com.artillexstudios.axapi.nms.v26_3.items.HashedStack(net.minecraft.network.HashedStack.STREAM_CODEC.decode(this.buf));
    }

    @Override
    public void writeHashedStack(HashedStack stack) {
        net.minecraft.network.HashedStack.STREAM_CODEC.encode(this.buf, ((com.artillexstudios.axapi.nms.v26_3.items.HashedStack) stack).stack());
    }
