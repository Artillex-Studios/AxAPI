package com.artillexstudios.axapi.nms.v26_3.items.datacomponents.impl;
...
public final class CustomDataDataComponent implements DataComponentHandler<CompoundTag, CustomData> {
    ...
    public CustomData toNMS(CompoundTag from) {
        return CustomData.of(((com.artillexstudios.axapi.nms.v26_3.items.nbt.CompoundTag) from).getParent());
    }

    @Override
    public CompoundTag fromNMS(CustomData data) {
        return new com.artillexstudios.axapi.nms.v26_3.items.nbt.CompoundTag(data.copyTag());
    }
