package com.artillexstudios.axapi.nms.v26_3;
...
import com.artillexstudios.axapi.nms.v26_3.entity.PacketEntity;
import com.artillexstudios.axapi.nms.v26_3.items.datacomponents.DataComponentTypes;
import com.artillexstudios.axapi.nms.v26_3.items.nbt.CompoundTag;
import com.artillexstudios.axapi.nms.v26_3.loot.LootTable;
import com.artillexstudios.axapi.nms.v26_3.packet.PacketTransformer;
import com.artillexstudios.axapi.nms.v26_3.wrapper.WrapperMapperRegistry;
...
public class NMSHandler implements com.artillexstudios.axapi.nms.NMSHandler {
    ...
    public void openSignInput(SignInput signInput) {
        ...
        for (int i = 0; i < 4; i++) {
            text = text.setLine(i, ComponentSerializer.INSTANCE.toVanilla(i > signInput.getLines().length ? Component.empty() : signInput.getLines()[i]));
        }

        DynamicOps<Tag> dynamicOps = MinecraftServer.getServer().registryAccess().createSerializationContext(NbtOps.INSTANCE);
        tag.store("front_text", SignText.CODEC, dynamicOps, text.asImmutable());
        ClientboundBlockEntityDataPacket clientboundBlockEntityDataPacket = new ClientboundBlockEntityDataPacket(pos, BlockEntityTypes.SIGN, tag);
        ClientboundOpenSignEditorPacket openSignEditorPacket = new ClientboundOpenSignEditorPacket(pos, SignTextSlot.FRONT);
