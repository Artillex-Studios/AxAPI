package com.artillexstudios.axapi.nms.v1_21_R6.items.data;
    ...
    public DataComponent<CompoundTag> customData() {
        return new DataComponent<>() {
            ...
            public CompoundTag get(Object item) {
                ...
                return new com.artillexstudios.axapi.nms.v1_21_R6.items.nbt.CompoundTag(itemStack.getOrDefault(DataComponents.CUSTOM_DATA, CustomData.of(new net.minecraft.nbt.CompoundTag())).copyTag());
            }
        };
    }
