...
public class Serializers {
    ...
    static {
        ...
        typeTransformers.put(EntityDataSerializers.Type.COMPONENT, new Transformer<Component>() {
            ...
            @Override
            public net.minecraft.network.syncher.EntityDataSerializer<net.minecraft.network.chat.Component> serializer() {
        ...
        typeTransformers.put(EntityDataSerializers.Type.OPTIONAL_COMPONENT, new Transformer<Optional<Component>>() {
            ...
            @Override
            public net.minecraft.network.syncher.EntityDataSerializer<Optional<net.minecraft.network.chat.Component>> serializer() {
    ...
    public interface Transformer<Z> {
        ...
        net.minecraft.network.syncher.EntityDataSerializer<Z> serializer();
    }
}
