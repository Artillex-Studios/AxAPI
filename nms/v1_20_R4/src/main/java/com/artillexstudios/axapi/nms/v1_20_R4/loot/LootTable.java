package com.artillexstudios.axapi.nms.v1_20_R4.loot;
...
public class LootTable implements com.artillexstudios.axapi.loot.LootTable {
    ...
    public LootTable(Key key) {
        this.lootTable = MinecraftServer.getServer().reloadableRegistries().getLootTable(ResourceKey.create(Registries.LOOT_TABLE, new ResourceLocation(key.namespace(), key.value())));
    }
