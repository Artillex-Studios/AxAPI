...
public final class ChannelDuplexHandlerPacketListener extends ChannelDuplexHandler {
    ...
    private static final Class<?> interactWrapperClass = ClassUtils.INSTANCE.getClassOrNull("com.ticxo.modelengine.v1_20_R4.network.patch.ServerboundInteractPacketWrapper");
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        PacketEvent event = new PacketEvent(this.player, PacketSide.SERVER_BOUND, type, () -> {
            return PacketTransformer.transformServerbound(ctx, finalMsg, FriendlyByteBuf::readVarInt);
        }, () -> {
            return PacketTransformer.newByteBuf(ctx, buf -> {
                buf.writeVarInt(packetId);
            });
