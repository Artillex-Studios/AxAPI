...
public final class CustomDataDataComponent implements DataComponentHandler<CompoundTag, CustomData> {
    ...
    public CustomData toNMS(CompoundTag from) {
        return CustomData.of(((com.artillexstudios.axapi.nms.v1_20_R4.items.nbt.CompoundTag) from).getParent());
    }

    @Override
    public CompoundTag fromNMS(CustomData data) {
        return new com.artillexstudios.axapi.nms.v1_20_R4.items.nbt.CompoundTag(data.getUnsafe());
    }
}
