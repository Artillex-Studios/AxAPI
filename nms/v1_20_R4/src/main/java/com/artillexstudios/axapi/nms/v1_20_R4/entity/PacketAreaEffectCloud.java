...
public class PacketAreaEffectCloud extends PacketEntity implements com.artillexstudios.axapi.entity.impl.PacketAreaEffectCloud {
    ...
    public <T> void setParticle(Particle particle, T data) {
        ...
        this.data.set(EntityData.AREA_EFFECT_CLOUD_PARTICLE, CraftParticle.createParticleParam(particle, data));
    }
...
//        this.data.define(EntityData.AREA_EFFECT_CLOUD_PARTICLE, ParticleTypes.ENTITY_EFFECT); // TODO: FIX
    }
}
