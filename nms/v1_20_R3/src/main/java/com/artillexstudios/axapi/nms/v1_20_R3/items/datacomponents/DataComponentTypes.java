package com.artillexstudios.axapi.nms.v1_20_R3.items.datacomponents;
...
import com.artillexstudios.axapi.nms.v1_20_R3.items.datacomponents.impl.CustomDataDataComponent;
import com.artillexstudios.axapi.nms.v1_20_R3.items.datacomponents.impl.CustomModelDataDataComponent;
import com.artillexstudios.axapi.nms.v1_20_R3.items.datacomponents.impl.DataComponentHandler;
import com.artillexstudios.axapi.nms.v1_20_R3.items.datacomponents.impl.DyedColorDataComponent;
import com.artillexstudios.axapi.nms.v1_20_R3.items.datacomponents.impl.EnchantmentGlintOverrideDataComponent;
...
import com.artillexstudios.axapi.nms.v1_20_R3.items.datacomponents.impl.UnbreakableDataComponent;
...
//        register("base_color", DataComponents.BASE_COLOR, new DyedColorDataComponent());
    ...
    public static <T, Z> void register(String id, DataComponentHandler<T> mapper) {
        register(id, com.artillexstudios.axapi.nms.v1_20_R3.items.datacomponents.impl.DataComponent.create(id, mapper));
    }
