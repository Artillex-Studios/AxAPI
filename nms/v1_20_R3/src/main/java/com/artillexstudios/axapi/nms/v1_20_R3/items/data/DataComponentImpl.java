    ...
    public DataComponent<ItemEnchantments> storedEnchantments() {
        return new DataComponent<>() {
            ...
            public void apply(Object item, ItemEnchantments itemEnchantments) {
                ...
                for (Map.Entry<Enchantment, Integer> entry : itemEnchantments.entrySet()) {
                    EnchantedBookItem.addEnchantment(itemStack, new EnchantmentInstance(CraftEnchantment.bukkitToMinecraft(entry.getKey()), entry.getValue()));
                }
            }
    ...
    public DataComponent<PotionType> potionType() {
        return new DataComponent<>() {
            ...
            public void apply(Object item, PotionType potionType) {
                ...
                tag.putString("Potion", CraftPotionType.bukkitToString(potionType));
            }
            ...
            public PotionType get(Object item) {
                ...
                return CraftPotionType.stringToBukkit(tag.getString("Potion"));
            }
        };
    }
}
