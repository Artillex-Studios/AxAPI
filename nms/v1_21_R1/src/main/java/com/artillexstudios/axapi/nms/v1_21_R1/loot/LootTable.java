package com.artillexstudios.axapi.nms.v1_21_R1.loot;
...
public class LootTable implements com.artillexstudios.axapi.loot.LootTable {
    private static final IdentityHashMap<LootContextParam<?>, net.minecraft.world.level.storage.loot.parameters.LootContextParam<Object>> params = new IdentityHashMap<>() {{
        this.put(LootContextParams.ATTACKING_ENTITY, (net.minecraft.world.level.storage.loot.parameters.LootContextParam<Object>) (Object) net.minecraft.world.level.storage.loot.parameters.LootContextParams.ATTACKING_ENTITY);
        ...
        this.put(LootContextParams.DIRECT_ATTACKING_ENTITY, (net.minecraft.world.level.storage.loot.parameters.LootContextParam<Object>) (Object) net.minecraft.world.level.storage.loot.parameters.LootContextParams.DIRECT_ATTACKING_ENTITY);
