package com.artillexstudios.axapi.nms.v1_21_R1.items.data;
    ...
    public DataComponent<CompoundTag> customData() {
        return new DataComponent<>() {
            ...
            public CompoundTag get(Object item) {
                ...
                return new com.artillexstudios.axapi.nms.v1_21_R1.items.nbt.CompoundTag(itemStack.getOrDefault(net.minecraft.core.component.DataComponents.CUSTOM_DATA, CustomData.of(new net.minecraft.nbt.CompoundTag())).copyTag());
            }
        };
    }
