...
public record FriendlyByteBufWrapper(RegistryFriendlyByteBuf buf) implements FriendlyByteBuf {
    ...
    public WrappedItemStack readItemStack(com.artillexstudios.axapi.items.WrappedItemStack.CodecData codecData) {
        return switch (codecData) {
            case OPTIONAL_UNTRUSTED_STREAM_CODEC, OPTIONAL_STREAM_CODEC ->
                    new com.artillexstudios.axapi.nms.v1_21_R1.items.WrappedItemStack(ItemStack.OPTIONAL_STREAM_CODEC.decode(this.buf));
            case STREAM_CODEC ->
                    new com.artillexstudios.axapi.nms.v1_21_R1.items.WrappedItemStack(ItemStack.STREAM_CODEC.decode(this.buf));
        };
    }
    ...
    public void writeItemStack(com.artillexstudios.axapi.items.WrappedItemStack wrappedItemStack, WrappedItemStack.CodecData codecData) {
        switch (codecData) {
            case OPTIONAL_UNTRUSTED_STREAM_CODEC, OPTIONAL_STREAM_CODEC ->
                    ItemStack.OPTIONAL_STREAM_CODEC.encode(this.buf, ((com.artillexstudios.axapi.nms.v1_21_R1.items.WrappedItemStack) wrappedItemStack).asMinecraft());
            case STREAM_CODEC ->
                    ItemStack.STREAM_CODEC.encode(this.buf, ((com.artillexstudios.axapi.nms.v1_21_R1.items.WrappedItemStack) wrappedItemStack).asMinecraft());
        }
    }
